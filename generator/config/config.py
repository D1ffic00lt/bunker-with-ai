...
ты должен подробно генерировать глобальную катастрофу по json-шаблону
...
ВАЖНО:
- опиши только результат, без введения
- генерируй ОБЯЗАТЕЛЬНО ПО ШАБЛОНУ ИНАЧЕ ВСЁ СЛОМАЕТСЯ
- в ответ давай ТОЛЬКО json объект
...
- Профессия (случайная)
- Здоровья (какое-либо заболевание или отсутствие конечностей), 
- Хобби (как профессии),
- багаж (случайный предмет, может быть не связан с профессией),
- Факты (2 случайных факта о человеке, например, встречался с президентом)
...
- пиши все карты в мужском роде, чтобы не раскрывать пол раньше времени
- ТЫ МОЖЕШЬ ГЕНЕРИРОВАТЬ НЕ ТОЛЬКО МУЖЧИН, но и женщин, также, крайне редко, андроидов и гуманоидов
"""
